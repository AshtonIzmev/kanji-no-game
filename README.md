...
npm run fonts         # subset Noto Sans/Serif JP to the corpus
npm run dev
```
...
have no components, and inventing some would be a lie.
...
Fonts are Noto Sans JP / Noto Serif JP under the SIL Open Font License 1.1
